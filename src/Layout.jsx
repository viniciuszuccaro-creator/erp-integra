...
const navigationItems = [
  ...
  { title: "🎯 Funil CRM com IA", url: createPageUrl("CRMFunil"), icon: Users, group: "principal" },
  { title: "🔗 Hub de Integrações", url: createPageUrl("IntegracoesHub"), icon: Link2, group: "principal" },
  { title: "📊 BI & Dashboards", url: createPageUrl("BIDashboards"), icon: BarChart3, group: "principal" },
  ...
  { title: "🏭 Kanban Produção IA", url: createPageUrl("ProducaoKanban"), icon: Factory, group: "operacional" },
  { title: "🚚 Romaneios & Logística", url: createPageUrl("LogisticaRomaneios"), icon: Truck, group: "operacional" },
  { title: "Financeiro e Contábil", url: createPageUrl("Financeiro"), icon: DollarSign, group: "administrativo" },
  { title: "💰 Caixa Unificado", url: createPageUrl("FinanceiroCaixa"), icon: Wallet, group: "administrativo" },
  { title: "🧾 Motor Fiscal IA", url: createPageUrl("FiscalMotor"), icon: FileText, group: "administrativo" },
  { title: "👥 Produtividade RH", url: createPageUrl("RHProdutividade"), icon: Award, group: "administrativo" },
  ...
  { title: "✅ Validador Etapas 5-12", url: createPageUrl("ValidadorEtapas512"), icon: CheckCircle, group: "sistema", adminOnly: true },
