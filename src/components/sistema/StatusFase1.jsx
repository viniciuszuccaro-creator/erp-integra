      ...
      <Card className="border-2 border-green-500 bg-gradient-to-br from-green-50 to-emerald-50 shadow-xl">
        <CardContent className="p-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">
                  TODO • 7 core • 52 wins • 19 ações • 10 mód • MEGA-ABSOLUTO
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-4 gap-3 mt-4 pt-4 border-t border-green-200">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-900">52</div>
              <div className="text-xs text-green-700">Windows Ready</div>
            </div>
            <div className="text-center">
