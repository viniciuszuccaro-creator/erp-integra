...
/**
 * V21.0 - CADASTRO CLIENTE STANDALONE (SEM DIALOG)
 * Usado dentro de janelas multitarefa
 */
export default function CadastroClienteCompleto({ cliente, onSubmit, isSubmitting }) {
  ...
  const handleDadosCNPJ = (dados) => {
    ...
    toast.success(`✅ Dados da Receita Federal preenchidos! ${dados.razao_social}`);
  };
  ...
  useEffect(() => {
    if (cliente) {
      setFormData({
        ...
        condicao_comercial: cliente.condicao_comercial || initialFormData.condicao_comercial,
        configuracao_fiscal: cliente.configuracao_fiscal || initialFormData.configuracao_fiscal,
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      {/* Header fixo */}
      <div className="border-b pb-4 px-6 pt-6 flex-shrink-0 bg-gradient-to-r from-blue-50 to-purple-50">
