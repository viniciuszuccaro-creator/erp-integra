...
export default function KPIsPagar({ totais }) {
  return (
    <div className="grid grid-cols-4 gap-2 min-h-[100px] max-h-[100px]">
      <Card className="border-0 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 pt-3 px-3">
          <CardTitle className="text-xs font-medium">Total a Pagar</CardTitle>
      ...
      <Card className="border-0 shadow-sm">
        ...
        <CardContent className="px-3 pb-2">
          ...
          <p className="text-xs text-muted-foreground">Não pagas</p>
        </CardContent>
      </Card>
