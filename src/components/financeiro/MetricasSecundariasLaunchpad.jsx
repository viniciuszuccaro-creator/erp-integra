...
export default function MetricasSecundariasLaunchpad({ 
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
      <Card className="border-0 shadow-sm bg-blue-50 border-blue-200 min-h-[85px] max-h-[85px]">
        <CardContent className="p-2.5 flex items-center justify-between h-full">
      ...
      <Card className="border-0 shadow-sm bg-purple-50 border-purple-200 min-h-[85px] max-h-[85px]">
        <CardContent className="p-2.5 flex items-center justify-between h-full">
          <div className="min-w-0 flex-1">
      ...
      <Card className="border-0 shadow-sm bg-orange-50 border-orange-200 min-h-[85px] max-h-[85px]">
        <CardContent className="p-2.5 flex items-center justify-between h-full">
          <div className="min-w-0 flex-1">
      ...
      <Card className="border-0 shadow-sm bg-green-50 border-green-200 min-h-[85px] max-h-[85px]">
        <CardContent className="p-2.5 flex items-center justify-between h-full">
          <div className="min-w-0 flex-1">
      ...
      <Card className="border-0 shadow-sm bg-red-50 border-red-200 min-h-[85px] max-h-[85px]">
        <CardContent className="p-2.5 flex items-center justify-between h-full">
          <div className="min-w-0 flex-1">
