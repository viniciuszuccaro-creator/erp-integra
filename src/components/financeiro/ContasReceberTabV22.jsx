...
import {
  DollarSign, Calendar, CheckCircle2, AlertCircle, Clock, CreditCard, FileText, MessageSquare,
  Plus, Edit, QrCode, Building2, Zap, Send, Wallet, Printer, Eye, ShoppingCart, Store, Smartphone
} from "lucide-react";
...
export default function ContasReceberTabV22({ contas, empresas = [] }) {
