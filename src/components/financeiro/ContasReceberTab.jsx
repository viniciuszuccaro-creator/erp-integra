...
import { Plus, Eye, DollarSign, Calendar } from "lucide-react";
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <BuscadorUniversal
          ...
          placeholder="🔍 Buscar: cliente, documento, valor, data, forma pagamento..."
          showAlert={false}
        />
            ...
            <TableBody>
              {contasFiltradas.map((conta) => (
                <TableRow key={conta.id} className="hover:bg-slate-50">
                  ...
                  <TableCell className="text-sm">{conta.cliente || '-'}</TableCell>
