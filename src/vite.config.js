...
function blockDocumentationInSrc() {
  ...
  return {
    ...
    resolveId(source, importer) {
      ...
      const looksBlocked = blockedExtPattern.test(normalized) || blockedNamePattern.test(normalized) || /\.md\.jsx$/i.test(normalized) || /\.json\.jsx$/i.test(normalized);
    ...
    load(id) {
      ...
      if (blockedExtPattern.test(normalized) || blockedNamePattern.test(normalized) || /\.md\.jsx$/i.test(normalized) || /\.json\.jsx$/i.test(normalized)) {
