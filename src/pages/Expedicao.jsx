...
export default function Expedicao() {
  ...
  const modules = [
    ...
    },
    {
      ...
      icon: Route,
      color: 'purple',
      component: () => import('@/components/logistica/PainelRoteirizacao').then(m => m.default),
    ...
    },
    {
      ...
      icon: Truck,
      color: 'green',
      component: () => import('@/components/logistica/DashboardEntregasGestor').then(m => m.default),
    ...
    },
    {
      ...
      icon: Activity,
      color: 'cyan',
      component: () => import('@/components/logistica/MonitorEntregasRealtime').then(m => m.default),
